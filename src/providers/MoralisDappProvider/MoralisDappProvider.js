...
function MoralisDappProvider({ children }) {
  ...
  return (
    <MoralisDappContext.Provider value={{ walletAddress, chainId, selectedCategory, setSelectedCategory, selectedFund, setSelectedFund, contractABI, setContractABI, contractAddress, setContractAddress }}>
      {children}
